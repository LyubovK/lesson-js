...
function t9() {
  let data = document.querySelector(".i-9"); // получили значение
...
function t10() {
  let data = document.querySelector(".i-10"); // получили значение
  let div = document.querySelector(".out-10");
  div.textContent = Number(data.value) * 20;
  data.value = "";
}
...
function t11() {
  let data = document.querySelector(".i-11"); // получили значение
  let div = document.querySelector(".out-11");
  div.textContent = data.value + 55;
  data.value = "";
}
...
//После чего вывести в .out-12  строку 'Hello имя фамилия', где имя - имя пользователя и фамилия - введенная фамилия. Обращаю ваше внимание -
// с этого момента мы работаем строго по заданию. Hello - с большой буквы. Между Hello имя один пробел (вы же включили отображение пробелов?).
...
function t12() {
  ...
  let data2 = document.querySelector(".i-12-2"); // получили значение
  let div = document.querySelector(".out-12");
  div.textContent = "Hello" + " " + data2.value + " " + data1.value;
  data1.value = "";
  data2.value = "";
}
...
function t13() {
  let data1 = document.querySelector(".i-13-1");
  let data2 = document.querySelector(".i-13-2"); // получили значение
  let div = document.querySelector(".out-13");
  div.textContent = Number(data1.value) + Number(data2.value);
  data1.value = "";
  data2.value = "";
}
...
function t16() {
  ...
  let data2 = document.querySelector(".i-16-2"); // получили значение
  let div = document.querySelector(".out-16");
  div.textContent = data1.value + data2.value;
  data1.value = "";
  data2.value = "";
}
