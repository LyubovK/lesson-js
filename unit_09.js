...
const paragraph6 = document.querySelectorAll(".p-6");

document.querySelector(".b-6").onclick = () => {
  let count = 0;
  for (let i = 0; i < paragraph6.length; i++) {
    count++;
  }
  out6.innerHTML = count;
};
...
const div7 = document.querySelectorAll(".out-7");

document.querySelector(".b-7").onclick = () => {
  for (let i = 0; i < div7.length; i++) {
    div7[i].classList.add("bg-orange");
  }
};
...
const div8 = document.querySelectorAll(".out-8");

document.querySelector(".b-8").onclick = () => {
  for (let i = 0; i < div8.length; i++) {
    div8[i].classList.toggle("bg-orange");
  }
};

//  Task 9
// Усложним предыдущие задачи. С помощью цикла повесим на блоки .out-9 событие клик.
// По клику должна выполняться функция f9. Функция, должна добавлять класс .bg-orange тому .out-9 на котором кликнули.
...
//  Task 18
// Кнопкa .b-18, которая запускает функцию f18.
// Функция с помощью getAttribute получает data-b атрибут с параграф .p-18 и выводит в .out-18.
const out18 = document.querySelector(".out-18");
const p18 = document.querySelector(".p-18").getAttribute("data-b");
function f18() {
  out18.innerHTML = p18;
}
